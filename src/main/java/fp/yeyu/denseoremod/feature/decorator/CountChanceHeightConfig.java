...
public class CountChanceHeightConfig implements DecoratorConfig {
    ...
    public CountChanceHeightConfig(float chance, int count, int bottomOffset, int range, BlockUtils.Target target) {
        this.chance = chance;
        this.count = count;
    ...
    public static CountChanceHeightConfig deserialize(Dynamic<?> dynamic) {
        ...
        final BlockUtils.Target target = BlockUtils.Target.byName(dynamic.get("target").asString(""));
